...
blob and easier for downstream export/indexing tools to process. If a
field becomes part of a strict application reporting contract, promote it in the
application's audit sink or warehouse schema.
...
behind adapters. Preserve Keepsake's durable audit fields and append
